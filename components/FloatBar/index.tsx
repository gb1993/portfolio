...
const FloatBar = () => {
  ...
  // Função para normalizar o pathname (remove a barra final, se não for a raiz)
  ...
  const title = [
    ...
    { link: "/*", text: "ESTÁ", highlight: "PERDIDO?" },
  ];

  const currentTitle =
    title.find((item) => item.link === currentPath) ||
    title.find((item) => item.link === "/*");
        ...
        <ul className="flex flex-col gap-4 items-center">
            ...
            <Link href="/" className={`group ${floatBarItemCss}`}>
              ...
              <div
                className={`${iconContentCss} ${
                  currentPath === "/" ? "bg-primary" : "bg-black-secondary"
                }`}
              >
          ...
          <li>
            <Link href="/sobre" className={`group ${floatBarItemCss}`}>
              ...
              <div
                className={`${iconContentCss} ${
                  currentPath === "/sobre" ? "bg-primary" : "bg-black-secondary"
                }`}
              >
